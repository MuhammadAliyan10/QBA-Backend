...
type ExecuteWorkflowRequest struct {
	...
	// [NEW] Secure Secrets (passwords, API keys, tokens)
	// CRITICAL: These are NEVER logged to console, NATS, or database
...
func (x *ExecuteWorkflowRequest) GetSecrets() map[string]string {
	if x != nil {
		return x.Secrets
	}
	return nil
...
const file_workflow_proto_rawDesc = "" +
	"\n" +
	"\x0eworkflow.proto\x12\x06e2e.v1\"\x84\x03\n" +
	...
	"\x06config\x18\x04 \x01(\v2\x16.e2e.v1.WorkflowConfigR\x06config\x12E\n" +
	"\asecrets\x18\x05 \x03(\v2+.e2e.v1.ExecuteWorkflowRequest.SecretsEntryR\asecrets\x1a9\n" +
...
var file_workflow_proto_goTypes = []any{
	...
	nil,                             // 10: e2e.v1.ExecuteWorkflowRequest.SecretsEntry
	nil,                             // 11: e2e.v1.ResumeJobRequest.DataEntry
}
var file_workflow_proto_depIdxs = []int32{
	...
	10, // 2: e2e.v1.ExecuteWorkflowRequest.secrets:type_name -> e2e.v1.ExecuteWorkflowRequest.SecretsEntry
	11, // 3: e2e.v1.ResumeJobRequest.data:type_name -> e2e.v1.ResumeJobRequest.DataEntry
	0,  // 4: e2e.v1.WorkflowService.ExecuteWorkflow:input_type -> e2e.v1.ExecuteWorkflowRequest
	3,  // 5: e2e.v1.WorkflowService.GetJobStatus:input_type -> e2e.v1.GetJobStatusRequest
	5,  // 6: e2e.v1.WorkflowService.TerminateJob:input_type -> e2e.v1.TerminateJobRequest
	7,  // 7: e2e.v1.WorkflowService.ResumeJob:input_type -> e2e.v1.ResumeJobRequest
	2,  // 8: e2e.v1.WorkflowService.ExecuteWorkflow:output_type -> e2e.v1.ExecuteWorkflowResponse
	4,  // 9: e2e.v1.WorkflowService.GetJobStatus:output_type -> e2e.v1.GetJobStatusResponse
	6,  // 10: e2e.v1.WorkflowService.TerminateJob:output_type -> e2e.v1.TerminateJobResponse
	8,  // 11: e2e.v1.WorkflowService.ResumeJob:output_type -> e2e.v1.ResumeJobResponse
